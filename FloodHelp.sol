...
contract FloodHelp {
    ...
    function closeRequest(uint id) public {
        ...
        require(requests[id].open && (msg.sender == author || balance>=goal), unicode"You cannot close this request");
    ...
    function getAllOpenRequests(uint startId, uint quantity) public view returns (Request[] memory) {
